...
User.hasMany(DismissalRecord, { foreignKey: 'pickup_person_user_id', as: 'dismissalRecords' });
...
DismissalRecord.belongsTo(User, { foreignKey: 'pickup_person_user_id', as: 'pickupPerson' });
